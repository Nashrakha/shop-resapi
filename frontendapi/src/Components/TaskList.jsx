...
function TaskList() {
    ...
    return (
        ...
        <div className="w-full flex flex-col lg:flex-row px-4 lg:px-10">
          {/* Left Form Section */}
          <div className="w-full lg:w-6/12 mt-5">
            <h1 className='text-orange-400 text-2xl lg:text-3xl font-sans capitalize px-2 lg:px-4'>
              Add New Shop Here
            </h1>
            ...
            <div className="px-2 lg:px-5">
              ...
              <button
                ...
                className='bg-green-400 hover:bg-green-500 text-white py-3 px-5 border-none rounded-lg mt-7 w-full sm:w-auto'
              >
                Add Shop
              </button>
            </div>
          ...
          {/* Right Table Section */}
          <div className="w-full lg:w-6/12 mt-5">
            <h1 className="text-orange-400 text-2xl lg:text-3xl font-sans capitalize px-2 mb-4">
              All shops will display here
            </h1>
      
            <div className="h-[400px] overflow-x-auto lg:overflow-y-auto border border-gray-300 rounded-lg">
              <table className="min-w-[600px] lg:min-w-full">
                <thead className="bg-gray-100 sticky top-0">
                  <tr>
                    <th className="border border-gray-400 px-2 py-2">Id</th>
                    <th className="border border-gray-400 px-2 py-2">Name</th>
                    <th className="border border-gray-400 px-2 py-2">Address</th>
                  ...
                  {shops.length === 0 ? (
                    ...
                    shops.map((shop, index) => (
                      <tr key={shop._id}>
                        ...
                        <td className="border border-gray-400 px-2 py-2">{shop.name}</td>
                        <td className="border border-gray-400 px-2 py-2">{shop.shop_address}</td>
                        <td className="border border-gray-400 px-2 py-2">{shop.product_category}</td>
